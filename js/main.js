...
function updateIssue(e) {
  ...
  var t = getEvent(e, 'target');
  t.href = 'https://github.com/axe-docs/axe-docs/issues/new?body=' + encodeURIComponent('Location: ' + window.location.href.toString() + "\n\n");
}
...
function updateSource(e) {
  ...
  t.href = 'https://github.com/axe-docs/axe-docs/edit/master/' + closer[0].getAttribute('data-sourcefile');
}
