...
{% endcomment %}
{% assign filename="_includes/devdoc/axe-core/rpcs/rpcs/fundrawtransaction.md" %}
...
{% highlight bash %}
axe-cli -testnet fundrawtransaction 01000000000100205fa012000000\
1976a914485485425fa99504ec1638ac4213f3cfc9f32ef388ac00000000

{% comment %}
KEPT IN CASE AXE IMPLEMENTS ADDITIONAL OPTIONS
