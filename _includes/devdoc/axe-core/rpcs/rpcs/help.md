...
{% endcomment %}
{% assign filename="_includes/devdoc/axe-core/rpcs/rpcs/help.md" %}
...
- n: "RPC"
  ...
  d: "The name of the RPC to get help for.  If omitted, Axe Core 0.10x will display an alphabetical list of commands; Axe Core 0.11.0 will display a categorized list of commands"
...
- n: "`result`"
  ...
  d: "The help text for the specified RPC or the list of commands.  The `axe-cli` command will parse this text and format it as human-readable text"
