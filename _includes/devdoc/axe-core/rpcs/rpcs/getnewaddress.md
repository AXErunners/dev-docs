...
{% endcomment %}
{% assign filename="_includes/devdoc/axe-core/rpcs/rpcs/getnewaddress.md" %}
...
*Result---a axe address never previously returned*
...
{% highlight bash %}
axe-cli -testnet getnewaddress "doc test"
{% endhighlight %}
