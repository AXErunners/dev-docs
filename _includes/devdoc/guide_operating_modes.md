...
**Resources:** [AxeJ][], a Java implementation of Axe based on BitcoinJ that uses
...
Until these types of operating modes are implemented, modes should be chosen based on the likely threat model, computing and bandwidth constraints, and liability in Axe value.
