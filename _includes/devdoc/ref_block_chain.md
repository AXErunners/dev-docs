...
<!-- Axe supported BIP34 from block 1
...
<!--
* **Version 536870913** blocks were introduced in Axe Core 0.??? (February 2017)
  at block height 617,288.

* **Version 536870912** blocks were introduced in Axe Core 0.??? ( 2017).
-->
...
<!-- Source for paragraph below: Axe Core src/tests/arith_uint256_tests.cpp:
...
<!-- source for "Axe Core converts..." src/pow.cpp GetBlockProof() -->
