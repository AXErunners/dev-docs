...
[open a pull request](https://github.com/axe-docs/axe-docs/compare)
...
GitHub](https://github.com/axe-docs/axe-docs/blob/master/docs/working-with-github.md).
Then change directory to the top-level of your local repository (replace
`axe.org` with the full path to your local repository clone):
...
`axe.org` directory and run the following command:
...
sure you're in the `axe.org` directory and run:
